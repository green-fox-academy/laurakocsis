...
app.get('/', (req, res) => {
  let alcoholPage = req.query.alcohol;
  if (alcoholPage) {
    const resultCocktails = cocktails.filter(e => {
      return e.contains.includes(alcoholPage);
    });
    res.render('home', { cocktails: resultCocktails, alcohols: alcoholList });
  } else {
